...
export function GuestEventPageClassic({ event }: GuestEventPageProps) {
  ...
  return (
    <div className="min-h-screen py-4 sm:py-8 px-3 sm:px-4 relative overflow-hidden" style={{ backgroundColor }}>
