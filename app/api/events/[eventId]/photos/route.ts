 ...
 * Zwraca listę zdjęć dla danego eventu (publicznie)
 */
 ...
 * Upload zdjęcia do Supabase Storage i zapis w bazie danych (publicznie)
 */
export async function POST(
  ...
  try {
    ...
    const authorName = (form.get("author_name") as string) || "Guest";
